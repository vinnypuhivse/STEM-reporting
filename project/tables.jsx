      ...
      h('table', { className: 'data' },
        h('thead', null,
          h('tr', null,
            ...
            h(Th, { label: 'Date of last activity', sub: 'Last viewed', sortKey: 'last', onSort: toggle, current: sort, info: 'Most recent time this student used Newsela.' }),
        ...
        h('tbody', null,
          rows.map(s => h('tr', { key: s.name },
            ...
            h('td', null, s.last === 'N/A' ? 'N/A' : s.last.split(' at ')[0]),
      ...
      h('table', { className: 'data' },
        h('thead', null,
          h('tr', null,
            ...
            h(Th, { label: 'Date of last activity', sub: 'Last viewed', sortKey: 'last', onSort: toggle, current: sort }),
