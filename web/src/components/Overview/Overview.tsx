    ...
    <section className={styles.section} data-screen-label="Overview">
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.card}>
          ...
          <button className={styles.infoBtn} aria-label="More info about average reading level">
            <InfoIcon />
          </button>
          <div className={styles.rows}>
            <div className={styles.row}>
              <div className={styles.rowVal}>8th</div>
              <div className={styles.rowLbl}>
                Average grade level for all texts viewed by Sarah
              </div>
            </div>
            <div className={styles.row}>
              <div className={styles.rowVal}>1030L</div>
              <div className={styles.rowLbl}>
                Average Lexile level for all texts viewed by Sarah
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={`${styles.card} ${styles.totalsCard}`}>
          <div className={styles.totalsHead}>
            ...
            <button className={styles.totalsInfoBtn} aria-label="More info about reading totals">
              <InfoIcon />
            </button>
          </div>
        ...
        {/* ── Right: Grade level callout ── */}
        <div className={`${styles.card} ${styles.gradeCard}`}>
          <button className={styles.infoBtn} aria-label="More info about grade level">
            <InfoIcon />
          </button>
